...
public class Texts {
    ...
    public static String PREFIX = "message.skylands.prefix";

    public static String getTextString(Text text) {
        if (text.getContent() instanceof TranslatableTextContent tanslatable) {
            return Localization.text(text, ServerLanguage.getLanguage(SkylandsMain.MAIN_CONFIG.language())).getString();
