...
public class HubCommands {
    ...
    public static void init(CommandDispatcher<ServerCommandSource> dispatcher) {
        register(dispatcher, node()
            .then(literal("hub")
                .requires(Permissions.require("skylands.teleport.hub", true))
                .executes(context -> {
            ...
            .then(literal("hub").requires(Permissions.require("skylands.admin.hub", 4))
                ...
                .then(literal("protection").requires(Permissions.require("skylands.admin.hub.protection", 4))
                    ...
                    .executes(context -> {
                        ...
                        Skylands skylands = Skylands.getInstance();
    ...
    static void visit(ServerPlayerEntity player, MinecraftServer server) {
        ...
        FabricDimensions.teleport(player, server.getOverworld(), new TeleportTarget(Skylands.getInstance().hub.pos, new Vec3d(0, 0, 0), 0, 0));
    }
