...
public class BanCommands {
    ...
    static void init(CommandDispatcher<ServerCommandSource> dispatcher) {
        register(dispatcher, node().then(literal("ban").requires(Permissions.require("skylands.command.ban", true))
        ...
        register(dispatcher, node().then(literal("unban").requires(Permissions.require("skylands.command.unban", true))
                .then(argument("player", word()).suggests((context, builder) -> {
                    var player = context.getSource().getPlayer();
